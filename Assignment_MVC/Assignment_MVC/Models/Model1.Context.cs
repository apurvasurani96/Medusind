...
namespace Assignment_MVC.Models
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual ObjectResult<Cust_Data_Result> Cust_Data()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Cust_Data_Result>("Cust_Data");
        }
    
        public virtual ObjectResult<ord_data_Result> ord_data()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ord_data_Result>("ord_data");
        }
    }
}
